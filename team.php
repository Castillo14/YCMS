...
<body>
    ...
    <section class="ftco-cover" style="background-image: url(img/our_team_2.png);" id="section-home" data-aos="fade"  data-stellar-background-ratio="0.5">
      <div class="container">
    ...
    <div class="ftco-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 text-center mb-5 pb-5">
            <h2>Our Gallery</h2>
          </div>
        </div>
      </div>
      <div class="container-fluid block-4">
        <div class="nonloop owl-carousel">
          <div class="item">
            <img src="img/3D-Computer.png" alt="Image placeholder">
          </div>
          <div class="item">
            <img src="img/ym.png" alt="Image placeholder">
          </div>
          <div class="item">
            <img src="img/lmb.png" alt="Image placeholder">
          </div>
          <div class="item">
            <img src="img/simsoh.png" alt="Image placeholder">
          </div>
          <div class="item">
            <img src="img/jobcon.png" alt="Image placeholder">
          </div>
          <div class="item">
            <img src="img/sta.png" alt="Image placeholder">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <div class="block-10">
              <div class="person-info">
                <span class="name">Amnisah Abubacar Sabado</span>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-10">
              <div class="person-info">
                <span class="name">Ferdenand Lawag Sabado </span>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-10">
              <div class="person-info">
                <span class="name">Almar Medina </span>
                <span class="position">Head Technical Support in Hardware and Networking</span>
              </div>
              <img src="img/download.png" alt="" class="img-fluid">
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-10">
              <div class="person-info">
                <span class="name">Bong Rodilas </span>
                <span class="position">Technical Support in CCTV and Networking
</span>
              </div>
              <img src="img/download.png" alt="" class="img-fluid">
            </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-10">
              <div class="person-info">
                <span class="name">Francis Avila </span>
                <span class="position">Technical Support in Hardware and Software</span>
              </div>
              <img src="img/download.png" alt="" class="img-fluid">
            </div>
          </div>
          <div class="col-md-6 col-lg-4">
            <div class="block-10">
              <div class="person-info">
                <span class="name">Cecil Habac </span>
                <span class="position">Office Administrator</span>
              </div>
              <img src="img/download.png" alt="" class="img-fluid">
            </div>
          </div>
