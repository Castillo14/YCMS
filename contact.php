...
<body>
    ...
    <section class="ftco-cover" style="background-image: url(img/contact_us_2.png);" id="section-home" data-aos="fade"  data-stellar-background-ratio="0.5">
      <div class="container">
    ...
    <div class="container">
      <div class="row block-9">
        ...
        <div class="col-md-6">
            <iframe width="100%" height="80%" src="https://maps.google.com/maps?q=Cambridge%20Village%20Floodway%2C%20Brgy.%20San%20Andres%2C%20Cainta%2C%20Rizal&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
        </div>
      </div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up">
          <div class="media block-6">
            <div class="media-body">
              <h3 class="heading">Contact Numbers :</h3>
              <p>09075251376 / 09363903744 / 09174363040 / 09182550953</p>
            </div>
          </div>      
        </div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="media block-6">
            <div class="media-body">
              ...
              <p>Cluster 5 Unit 1-G Cambridge Village Floodway, Brgy. San Andres, Cainta, Rizal</p>
            </div>
          </div>    
        </div>
