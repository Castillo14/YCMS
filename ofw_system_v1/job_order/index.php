...
<?php
	...
	$get_account = "SELECT * FROM tbl_job_order WHERE job_order_username = '$account_session'";
	$run_account = mysqli_query($con,$get_account);
	$row_account = mysqli_fetch_array($run_account);
	$account_id = $row_account['job_order_id'];
?>
	        			...
	        			<ul class="nav navbar-nav">
	          				<li class="dropdown user user-menu">
	            				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
	              					...
	              					<span class="hidden-xs">Agency</span>
	           					</a> 
