...
<script type="application/javascript">
    ...
    <?php
    	if(isset($_POST['submit'])){
			...
			$insert_document = "INSERT INTO tbl_documents (document_name,created_by,date_created,removed,date_removed,removed_by) VALUES ('$document_name','$creator',now(),'No','0000-00-00','')";
