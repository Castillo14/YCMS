...
<?php
	...
	if(isset($_GET['profile'])){
		...
		$edit_account = "SELECT * FROM tbl_accounts WHERE account_id = '$edit_id' AND removed = 'No'";
		$run_edit_account = mysqli_query($con,$edit_account);
		$row_edit_account = mysqli_fetch_array($run_edit_account);
		$e_id = $row_edit_account['account_id'];
		$e_fname = $row_edit_account['first_name'];
		$e_mname = $row_edit_account['middle_name'];
		$e_lname = $row_edit_account['last_name'];
		$e_email_address = $row_edit_account['email_address'];
		$e_contact_number = $row_edit_account['contact_number'];
		$e_username = $row_edit_account['account_username'];
		$e_password = $row_edit_account['account_password'];
		$e_address = $row_edit_account['address'];
		$e_image = $row_edit_account['image'];
	}
