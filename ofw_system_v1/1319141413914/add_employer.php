                ...
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                    <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label">
                            Employer ID Number <br> رقم بطاقة العمل
                        </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label">
                            National ID <br> رقم الوطني (السجل المدني)
                        </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                     ...
                     <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label">
                            Company Name <br> اسم المكتب
                        </label>
                        <div class="col-md-6">
                            <input type="text" name="company_name" class="form-control" required maxlength="224" minlength="2">
                        </div>
                    </div><!-- form-group Ends -->
                    <div class="form-group"><!-- form-group Starts -->
						...
						<label class="col-md-3 control-label">
							...
							Company Address <br> عنوان المكتب
...
<script type="application/javascript">
    ...
    <?php
    	if(isset($_POST['submit'])){
			...
			$insert_employerr = "INSERT INTO tbl_employer (employer_national_id,employer_first_name,employer_middle_name,employer_last_name,employer_arabic_name,employer_email_address,employer_contact_number,employer_username,employer_password,employer_company_address,employer_company_name) VALUES ('$national_id','$first_name','$middle_name','$last_name','$arabic_name','$email_address','$contact_number','$username','$password','$company_address','$company_name')";
			$run_insert_employerr = mysqli_query($conn,$insert_employerr);

                if($run_insert_employer && $run_insert_employerr){
