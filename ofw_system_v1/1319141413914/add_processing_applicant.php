    ...
    <div class="col-lg-12"><!-- col-lg-12 Starts -->
        <ol class="breadcrumb"><!-- breadcrumb Starts -->
            <li>
                ...
                Processing Applicants / Add Applicant
            </li>
        </ol><!-- breadcrumb Ends -->
    </div><!-- col-lg-12 Ends -->
</div><!-- 1 row Ends -->
                ...
                <form action="" method="post" class="form-horizontal"><!-- form Starts -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="address" rows="3" maxlength="224" minlength="5" required></textarea>
                            </div>  
                        </div>
                    </div>
                    <div class="col-md-6">
...
<?php
          ...
          $code_appl = "YaraMay-" . $count_total;
            ...
            $insert_applicant = "INSERT INTO tbl_applicants (applicant_code,position1,position2,position3,position_selected,first_name,middle_name,last_name,age,gender,contact_number,email_address,address,birth_place,birth_date,civil_status,height,weight,blood_type,religion,language_spoken,father_name,mother_name,passport_number,date_issue,place_issue,employer_id,created_by,date_created,application_status,application_mode,removed,date_removed,removed_by,owwa_number) VALUES ('$code_appl','$position1','$position2','$position3','','$first_name','$middle_name','$last_name','$age','$gender','$contact_number','$email_address','$address','$birth_place','$birth_date','$civil_status','$height','$weight','$blood_type','$religion','$language_spoken','$father_name','$mother_name','$passport_number','$date_issue','$place_issue','$employer_','$creator',now(),'2','walk-in','No','0000-00-00','','')";
