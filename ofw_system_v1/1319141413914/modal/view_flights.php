...
<div class="modal fade" id="view_flights<?php echo $flight_number; ?>" hidden="true" role="dialog">
	            ...
	            <div class="modal-content">
	              	<div class="modal-header">
	                	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                  	...
	                  	<center>
	                		<h4 class="modal-title text-center"><b>VIEW FLIGHT DETAILS</b></h4>
	                	</center>
	             	</div>
	              	<div class="modal-body">
	              		...
	              		?>
	              		<form class="form-horizontal" action="update_flight.php" method="post">
