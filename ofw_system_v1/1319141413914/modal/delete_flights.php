	            ...
	            <div class="modal-content">
	              	...
	              	<div class="modal-body">
	              		<?php
	              			...
	              			$get_flight = "SELECT * FROM tbl_flights WHERE flight_id = '$flight_number'";
	              			...
	              			$flight_number = $row_get['flight_id'];
	              		...
	              		?>
	    				<form class="form-horizontal" action="delete_flight.php" method="post" enctype="multipart/form-data">
