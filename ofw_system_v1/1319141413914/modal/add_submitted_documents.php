<div class="modal fade" id="add_submitted_documents<?php echo $e_id; ?>" hidden="true" role="dialog">
	              		...
	              		<div class="row">
	              			<div class="box box-success">
	              						...
	              						<span>
	              							<a href="#" class="btn-sm btn-success navbar-btn right">
	              								<?php
	              									...
	              									$get_documents = "SELECT * FROM tbl_documents WHERE removed = 'No'";
	              				...
	              				<div class="box-body table-responsive no-padding">
	              					<form action="add_sub_docu.php" method="post" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group"><!-- form-group Starts -->
								...
								<div class="col-md-6">
                                	...
                                	$get_agent = "SELECT * FROM tbl_documents WHERE removed = 'No'";
