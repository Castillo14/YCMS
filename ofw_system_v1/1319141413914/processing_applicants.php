	              					...
	              					<table class="table table-hover" id="ample2">
	                					...
	                					<tr>
	                  						...
	                  						<td>
												...
												<a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && remove_processing_applicant=<?php echo $applicant_id; ?> && getDelete=<?php echo $getDelete; ?>" class="btn btn-default btn-small">
													<i class="fa fa-remove"></i>
												</a>
												<a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && deploy_processing_applicant=<?php echo $applicant_id; ?> && getDeploy=<?php echo $getDelete; ?>" class="btn btn-default btn-small">
