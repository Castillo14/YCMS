...
<script type="application/javascript">
    ...
    <?php
    	if(isset($_POST['submit'])){
			...
			$insert_account = "INSERT INTO tbl_accounts (first_name,middle_name,last_name,email_address,contact_number,account_username,account_password,address,job,image,created_by,date_created,removed,date_removed,removed_by) VALUES ('$first_name','$middle_name','$last_name','$email_address','$contact_number','$username','$password','$address','$job','$image','$creator',now(),'No','0000-00-00','')";
