<?php
			...
			<?php
				if(isset($_GET['remove_deployed_applicant'])){
					$delete_id = $_GET['remove_deployed_applicant'];
					$delete_waiting = "SELECT * FROM tbl_applicants WHERE applicant_id = '$delete_id' AND application_status = '3' AND removed = 'No'";
			...
			<div class="panel-body"><!-- panel-body Starts -->
				<form action="" method="post" class="form-horizontal">
								...
								<div class="form-group"><!-- form-group Starts -->
									...
									<div class="col-md-6">
										<a href="index.php?deployed_applicants" class="btn btn-danger form-control">
											Cancel
										</a>
									</div>
								</div><!-- form-group Ends -->
...
<?php
		...
		$delete_ = "UPDATE tbl_applicants SET application_status = '2' WHERE applicant_id = '$d_id' AND removed = 'No'";
