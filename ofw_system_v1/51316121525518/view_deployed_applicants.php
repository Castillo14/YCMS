								...
								<form class='form-horizontal' action='' method='post'><!-- form-horizontal Starts -->
									<div class="col-md-6"><!-- col-md-12 Starts -->
										<div class="form-group"><!-- form-group Starts -->
											...
											<div class="col-md-8">
												<input type="text" class="form-control" name="first_name" maxlength="74" minlength="2" onkeypress='return isAlphaKey(event)' required disabled value="<?php echo $e_first; ?>">
											</div>
										</div><!-- form-group Ends -->
									</div><!-- col-md-12 Ends -->
									<div class="col-md-6"><!-- col-md-12 Starts -->
									...
									<div class='col-md-6'><!-- col-md-6 Starts -->
					                    <div class='form-group'>
					                        ...
					                        <div class='col-sm-8'>
					                        	<input type="text" class="form-control" name="middle_name" maxlength="74" minlength="2" disabled onkeypress='return isAlphaKey(event)' value="<?php echo $e_middle; ?>">
					                        </div>  
					                    </div>
					                    <div class='form-group'>
					                        <label class='control-label col-sm-4'>
					                        ...
					                        <div class='col-sm-8'>
					                            <input type="text" class="form-control" name="last_name" maxlength="74" minlength="2" disabled onkeypress='return isAlphaKey(event)' value="<?php echo $e_last; ?>">
					                        </div>  
					                    </div>
					                </div><!-- col-md-6 Ends -->
					                <div class='col-md-6'><!-- col-md-6 Starts -->
					                	<div class='form-group'>
					                        ...
					                        <div class='col-sm-8'>
					                            <textarea class='form-control' name='address' " maxlength="224" minlength="5" rows='2' disabled required><?php echo $e_address; ?></textarea>
					                        </div>  
					                    </div>
					                    <div class='form-group'>
					                        <label class='control-label col-sm-4'>
					                        ...
					                        <div class='col-sm-8'>
					                            <select class='form-control' disabled name='employer' id='select_employer'>
					                ...
					                <div class='col-md-12'><!-- col-md-12 Starts -->
					                	<ul class='nav nav-tabs'><!-- nav nav-tabs Starts -->
					    					...
					    					<li class=''>
					   	 					...
					   	 					<li class=''>
					      						<a href='' id='btn6' data-toggle='tab'>
					          						<i class='fa fa-file-o'></i> <span>Monthly Reports <br></span>
					      						</a>
					   	 					</li>
					                	...
					                	<div id='applicant_info'><!-- applicant_info Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" class="form-control" name="contact_number" required onkeypress='return isNumericKey(event)' maxlength="15" disabled minlength="5" value="<?php echo $e_contact; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" disabled class="form-control" name="language_spoken" minlength="3" maxlength="224" required value="<?php echo $e_language; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="date" disabled class="form-control" name="birth_date" required value="<?php echo $e_bdate; ?>">
							                        </div>  
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                        	 <input type="text" disabled class="form-control" name="birth_place" required value="<?php echo $e_bplace; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="email" disabled class="form-control" name="email_address" maxlength="224" minlength="5" value="<?php echo $e_email; ?>">
							                        </div>  
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" disabled class="form-control" name="father_name" minlength="3" maxlength="224" value="<?php echo $e_father; ?>">
							                        </div>  
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" class="form-control" name="mother_name" minlength="3" disabled maxlength="224" value="<?php echo $e_mother; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-4'>
							                            <input type="text" class="form-control" name="height" minlength="2" disabled maxlength="14" value="<?php echo $e_height; ?>">
							                        </div>
							                        <div class='col-sm-4'>
							                            <input type="text" class="form-control" name="weight" minlength="2" disabled maxlength="14" value="<?php echo $e_weight; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-4'>
							                            <select class='form-control' disabled name='blood_type'>
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <select class='form-control' disabled name='civil_status'>
							                ...
							                <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" disabled class="form-control" name="religion" minlength="2" maxlength="74" value="<?php echo $e_religion; ?>">
							                        </div>
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                             <input type="text" disabled class="form-control" name="passport_number" maxlength="9" minlength="9" value="<?php echo $e_passnumber; ?>" required>
							                        </div>
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                             <input type="date" disabled class="form-control" name="date_issue" value="<?php echo $e_dissue; ?>" required>
							                        </div>
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                        	 <input type="text" disabled class="form-control" name="place_issue" value="<?php echo $e_pissue; ?>" required maxlength="224" minlength="5">
							                        </div>
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-12'><!-- col-md-12 Starts -->
							                    <div class='form-group'>
							                        <div class='col-xs-6'>
						          						<a href='index.php?deployed_employees' class='btn btn-default pull-left'><i class='fa fa-close'></i> Close</a>
						        					</div>
							                    </div>
							                </div><!-- col-md-12 Ends -->
...
<div id='other_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'><!-- col-md-6 Starts -->
									                    <div class='form-group'>
									                        ...
									                        <div class='col-sm-4'>
									                            <input type="text" disabled class="form-control" name="owwa" value="<?php echo $e_owwa; ?>">
...
<div id='monthly' style='display: none;'>
									        <div class='col-md-12'>
									        	<button class='btn btn-default' type='button' data-toggle='modal' data-target='#add_report<?php echo $e_id; ?><?php echo $e_employerid; ?>'>
														<i class='fa fa-plus'></i>
														Add Report
													</button>
													<?php

														            	include("modal/add_report.php");
												...
												<div class='row'><!-- row Starts -->
													<div class='box box-success'><!--box box-success Starts -->
														<div class='box-header'><!-- box-header Starts -->
															<h3 class='box-title'>
																<i class='fa fa-file-o'></i> Monthly Report
																<span>
																	<a class='btn-sm btn-success navbar-btn right' href='#''><!-- btn btn-primary navbar-btn right Starts -->
																		<?php

																			$get_report = "SELECT * FROM tbl_reports WHERE applicant_id = '$e_id'";

																			$run_report = mysqli_query($con,$get_report);

																			$total_report = mysqli_num_rows($run_report);
														...
														<div class="box-body table-responsive no-padding"><!-- box-body table-responsive no-padding Starts -->
															<table class="table table-hover ample2">
													            ...
													            <?php
													            	...
													            	$get_flights_ee = "SELECT * FROM tbl_reports WHERE applicant_id = '$e_id'";

													            	$run_flights_ee = mysqli_query($con,$get_flights_ee);

													            	while($row_flights_ee = mysqli_fetch_array($run_flights_ee)){

													            		$app_idddd = $row_flights_ee['applicant_id'];
													            		$report_id = $row_flights_ee['report_id'];

													            		$monthly_salary = $row_flights_ee['monthly_salary'];
													            		
													            		$monthly_report = $row_flights_ee['monthly_report'];
													            		$date_add = $row_flights_ee['date_created'];
													            ...
													            ?>
													            	<tr>
													            		...
													            		<td><?php echo $date_add; ?></td>
													                  	<td>
													                  		<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#view_report<?php echo $report_id; ?>'>
					                  											<i class='fa fa-eye'></i>
					                  										</button>
													                  	</td>
													            	</tr>
	...
	if(isset($_POST['save'])){
            ...
            $owwa = mysqli_real_escape_string($con,$_POST['owwa']);
	    		...
	    		if($run_add){
					...
					echo "
						<script>
							window.open('index.php?deployed_employees','_self')
						</script>
					";
