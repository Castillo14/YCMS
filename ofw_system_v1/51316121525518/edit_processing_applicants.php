...
<?php
	                ...
	                $applicant_id = $_REQUEST["edit_processing_applicants"];
								...
								<form class='form-horizontal' action='' method='post'><!-- form-horizontal Starts -->
					                ...
					                <div class='col-md-6'><!-- col-md-6 Starts -->
					                    ...
					                    <div class='form-group'>
					                        ...
					                        <div class='col-sm-8'>
					                            <select class='form-control' name='employer' id='select_employer' disabled>
					    					...
					    					<li class=''>
					   	 					...
					   	 					<li class=''>
					      						<a href='' id='btn5' data-toggle='tab'>
					          						<i class='fa fa-bullhorn'></i> <span>Other Details</span>
					      						</a>
					   	 					</li>
					                	...
					                	<div id='applicant_info'><!-- applicant_info Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" class="form-control" name="contact_number" required onkeypress='return isNumericKey(event)' disabled maxlength="15" minlength="5" value="<?php echo $e_contact; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" class="form-control" name="language_spoken" minlength="3" disabled maxlength="224" required value="<?php echo $e_language; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="date" class="form-control" name="birth_date" required disabled value="<?php echo $e_bdate; ?>">
							                        </div>  
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                        	<input type="text" class="form-control" name="birth_place" disabled required value="<?php echo $e_bplace; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="email" class="form-control" name="email_address" disabled maxlength="224" minlength="5" value="<?php echo $e_email; ?>">
							                        </div>  
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" class="form-control" name="father_name" disabled minlength="3" maxlength="224" value="<?php echo $e_father; ?>">
							                        </div>  
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" class="form-control" name="mother_name" disabled minlength="3" maxlength="224" value="<?php echo $e_mother; ?>">
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    ...
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <input type="text" class="form-control" name="religion" minlength="2" disabled maxlength="74" value="<?php echo $e_religion; ?>">
							                        </div>
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                             <input type="text" class="form-control" name="passport_number" disabled maxlength="9" minlength="9" value="<?php echo $e_passnumber; ?>" required>
							                        </div>
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                             <input type="date" class="form-control" name="date_issue" disabled value="<?php echo $e_dissue; ?>" required>
							                        </div>
							                    </div>
							                </div>
							                    <div class='col-md-6'>
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                        	 <input type="date" class="form-control" name="place_issue" disabled value="<?php echo $e_pissue; ?>" required>
							                        </div>
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-12'><!-- col-md-12 Starts -->
								        ...
								        <div id='other_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'><!-- col-md-6 Starts -->
									                    <div class='form-group'>
									                        ...
									                        <div class='col-sm-4'>
									                            <input type="text" class="form-control" disabled name="owwa" value="<?php echo $e_owwa; ?>">
