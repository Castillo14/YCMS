<?php
			...
			<section class="content-header">
	      			...
	      			<ol class="breadcrumb">
	        			...
	        			<li class="active">Deployed Employees</li>
	      			</ol>
	    		</section>
	    		<!-- Main content -->
	    		<section class="content">
	    			<a href="index.php?deployed_employees" class="btn btn-default">
	        			...
	        			<div class="col-xs-12">
	          				<div class="box box-success">
	            				<div class="box-header">
	              					<h3 class="box-title"><i class="fa fa-users"></i> Deployed Employees 
	              						<span>
	              							<a class="btn-sm btn-primary navbar-btn right" href="#"><!-- btn btn-primary navbar-btn right Starts -->
	            								<?php

	            								$total = "SELECT * FROM tbl_applicants WHERE application_status = '3' AND removed = 'No' AND employer_id = '$account_id'";
	              					...
	              					<table class="table table-hover" id="ample2">
	                					...
	                					$jScript = md5(rand(1,9));
										 ...
										 $getUpdate = md5(rand(1,9));
	                						...
	                						$select_acc = "SELECT * FROM tbl_applicants WHERE application_status = '3' AND removed = 'No' AND employer_id = '$account_id'";
