        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <form action="" method="post" class="form-horizontal"><!-- form Starts -->
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label col-sm-5" for="father_name">
                                Father Name
                            </label>
                            <div class="col-sm-7">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label col-sm-5" for="mother_name">
                                Mother Name
                            </label>
                            <div class="col-sm-7">
