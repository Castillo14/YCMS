    ...
    <section class="ftco-cover" style="background-image: url(img/bg_1.jpg);" id="section-home" data-aos="fade"  data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center ftco-vh-75">
          <div class="col-md-7">
            <h1 class="ftco-heading mb-3" data-aos="fade-up" data-aos-delay="500">May Reklamo Na Ba Dati ?</h1>
                 <a href="complain.php" data-aos="fade-up" data-aos-delay="600" class="btn btn-danger">Wala</a>
                 <a href="complain_yes.php" data-aos="fade-up" data-aos-delay="600" class="btn btn-primary">Meron</a>
