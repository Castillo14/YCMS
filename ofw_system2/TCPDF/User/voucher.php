...
if(isset($_POST['submit'])){
        ...
        $date = $_POST['dt'];
                ...
                $insert_vc = "insert into tbl_voucher (pay_to,particulars,amount,created_by,date_release,note,changes) values ('$pay_to','$particulars','$amount','$prepare_by','$date','','0.00')";
