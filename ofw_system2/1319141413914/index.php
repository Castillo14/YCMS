	  		...
	  		<div class="content-wrapper">
	    		...
	    		<?php
		    		if(isset($_GET['view_agent_applicant'])){
	                    include("view_agent_applicant.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['view_applicant_expense'])){
	                    include("view_applicant_expense.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['add_applicant_expense'])){
	                    include("add_applicant_expense.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['edit_applicant_expense'])){
	                    include("edit_applicant_expense.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['delete_applicant_expense'])){
	                    include("delete_applicant_expense.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['deduct_applicant_expense'])){
	                    include("deduct_applicant_expense.php");
	                }
	    		?>
	    		<?php
	    		...
	    		<?php
		    		if(isset($_GET['edit_job_order'])){
	                    include("edit_job_order.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['delete_job_order'])){
	                    include("delete_job_order.php");
	                }
	    		?>
	    		<?php
	    		...
	    		<?php
		    		if(isset($_GET['cancel_voucher'])){
	                    include("cancel_voucher.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['excess_money'])){
	                    include("excess_money.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['reprint_voucher'])){
	                    include("reprint_voucher.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['employer_waiting_applicant'])){
	                    include("employer_waiting_applicant.php");
	                }
	    		?>
	    		<?php
		    		if(isset($_GET['employer_processing_applicant'])){
	                    include("employer_processing_applicant.php");
	                }
	    		?>
	  		</div>
