...
<?php
	                ...
	                $applicant_id = $_REQUEST["edit_processing_applicant"];
	    
	    			$applicant_id;       

                    $edit_applicant = "SELECT * FROM tbl_applicants WHERE applicant_id = '$applicant_id' AND application_status = '2' AND removed = 'No'";
                    ...
                    $e_date_signed = $row_edit['date_signed'];
                    $e_date_arrival = $row_edit['date_arrival'];
                    $e_owwa_sched = $row_edit['owwa_sched'];
                    $e_biometric_sched = $row_edit['biometric_sched'];
                    $e_visa_number = $row_edit['visa_number'];
                    $e_remarks = $row_edit['remarks'];
                    
                    $e_joid = $row_edit['jo_id'];

                    $e_agentid = $row_edit['agent_id'];

                    $get_emp = "SELECT * FROM tbl_job_order WHERE jo_id = '$e_joid'";

                    $run_emp = mysqli_query($con,$get_emp);

                    $row_emp = mysqli_fetch_array($run_emp);

                    $joname = $row_emp['jo_name'];

                    $get_agent = "SELECT * FROM tbl_agents WHERE agent_id = '$e_agentid'";

                    $run_agent = mysqli_query($con,$get_agent);

                    $row_agent = mysqli_fetch_array($run_agent);
                    $first_nn = $row_agent['first_name'];
                    $middle_nn = $row_agent['middle_name'];
                    $last_nn = $row_agent['last_name'];
                    
                    $full_nn = ucfirst($first_nn) . " " . ucfirst($middle_nn) . " " . ucfirst($last_nn);
								...
								<form class='form-horizontal' action='' method='post'><!-- form-horizontal Starts -->
					                    ...
					                    <div class='form-group'>
					                        ...
					                        <div class='col-sm-8'>
					                            <select class='form-control' name='agent'>
					                            	<option name='agent' selected value="<?php echo $e_agentid; ?>" hidden>
					                            		<?php echo $full_nn; ?>
					                            	</option>
					                            	...
					                            	$get_agentt = "SELECT * FROM tbl_agents WHERE removed = 'No'";

					                            	$run_agentt = mysqli_query($con,$get_agentt);

					                            	while($row_agentt = mysqli_fetch_array($run_agentt)){

					                            		$agentid = $row_agentt['agent_id'];
					                            		$first_naa = $row_agentt['first_name'];
									                    $middle_naa = $row_agentt['middle_name'];
									                    $last_naa = $row_agentt['last_name'];
									                    
									                    $name_fulll = ucfirst($first_naa) . " " . ucfirst($middle_naa) . " " . ucfirst($last_naa);

					                            	?>
					                            		<option name='agent' value="<?php echo $agentid; ?>">
					                            			<?php echo $name_fulll; ?>
					                            		</option>
					                            	<?php
					                            	}
					                    ...
					                    <div class='form-group'>
					                        ...
					                        <div class='col-sm-8'>
					                            <select class='form-control' name='jo'>
					                            	<option name='jo' selected value="<?php echo $e_joid; ?>" hidden>
					                            		<?php echo $joname; ?>
					                            	</option>
					                            	...
					                            	while($row_employer = mysqli_fetch_array($run_employer)){
					                            		...
					                            		$joid = $row_employer['jo_id'];
					                            		$name_jo = $row_employer['jo_name'];

					                            	?>
					                            		<option name='jo' value="<?php echo $joid; ?>">
					                            			<?php echo $name_jo; ?>
					                            		</option>
					                            	<?php
					                            	}
					    					...
					    					<li class=''>
					   	 					...
					   	 					<li class=''>
					      						<a href='' id='btn5' data-toggle='tab'>
					          						<i class='fa fa-calendar-times-o'></i> <span>Schedules</span>
					      						</a>
					   	 					</li>
					                ...
					                <section class='content-header'><!-- content-header Starts -->
					                	<div id='applicant_info'><!-- applicant_info Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    ...
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <textarea class="form-control" name="birth_place" rows="3" maxlength="224" minlength="5" required><?php echo $e_bplace; ?></textarea>
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    ...
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <textarea class="form-control" name="place_issue" rows="4" maxlength="224" minlength="5" required><?php echo $e_pissue; ?></textarea>
							                        </div>
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-12'><!-- col-md-12 Starts -->
					                	...
					                	<div id='status_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'>
									        	<button class='btn btn-default' type='button' data-toggle='modal' data-target='#add_submitted_documents<?php echo $e_id; ?>'>
													            ...
													            ?>
													            	<tr>
													            		...
													            		<td><a download="../submitted_documents/<?php echo $file_name; ?>" href="../submitted_documents/<?php echo $file_name; ?>"><?php echo $file_name; ?></a></td>
													                  	...
													                  	<td>
													                  		<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#update_submitted_documents<?php echo $submitted_id; ?>'>
					                  											<i class='fa fa-pencil'></i>
					                  										</button>
					                  										<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#delete_submitted_documents<?php echo $submitted_id; ?>'>
								        ...
								        <div id='flight' style='display: none;'>
									        <div class='col-md-12'>
										        <button class='btn btn-default' type='button' data-toggle='modal' data-target='#add_flights<?php echo $e_id; ?>'>
														<i class='fa fa-plus'></i>
														Add Flights
													</button>
													<?php
													            ...
													            ?>
													            	<tr>
													            		<td><?php echo $k; ?></td>
													                  	...
													                  	<td>
													                  		<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#update_flights<?php echo $flight_number; ?>'>
					                  											<i class='fa fa-pencil'></i>
					                  										</button>
					                  										<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#delete_flights<?php echo $flight_number; ?>'>
					                  											<i class='fa fa-trash-o'></i>
					                  										</button>
													                  	</td>
													            	</tr>
								        	...
								        	<?php
											        ...
											        <div class='col-md-12'><!-- col-md-6 Starts -->
									                    <div class='form-group'>
									                        ...
									                        <div class='col-sm-4'>
									                            <input type="text" class="form-control" name="owwa" value="<?php echo $e_owwa_sched; ?>" disabled>
									                ...
									                <div class='col-md-12'><!-- col-md-6 Starts -->
									                    <div class='form-group'>
									                        ...
									                        <div class='col-sm-4'>
									                            <input type="text" class="form-control" name="bio" value="<?php echo $e_biometric_sched; ?>" disabled>
									                ...
									                <div class='col-md-12'><!-- col-md-6 Starts -->
									                    <div class='form-group'>
									                        ...
									                        <div class='col-sm-4'>
									                            <input type="text" class="form-control" name="signed" value="<?php echo $e_date_signed; ?>" disabled>
									                ...
									                <div class='col-md-12'><!-- col-md-6 Starts -->
									                    <div class='form-group'>
									                        ...
									                        <div class='col-sm-4'>
									                            <input type="text" class="form-control" name="arrival" value="<?php echo $e_date_arrival; ?>" disabled>
									                ...
									                <div class='col-md-12'><!-- col-md-6 Starts -->
									                    <div class='form-group'>
									                        ...
									                        <div class='col-sm-4'>
									                            <input type="text" class="form-control" name="visa" value="<?php echo $e_visa_number; ?>" disabled>
									                ...
									                <div class='col-md-12'><!-- col-md-6 Starts -->
									                    <div class='form-group'>
									                        ...
									                        <div class='col-sm-4'>
									                        	<textarea name="remarks" class="form-control" cols="22" rows="3" disabled><?php echo $e_remarks; ?></textarea>
													            ...
													            ?>
													            	<tr>
													            		<td><?php echo $j; ?></td>
													                  	...
													                  	<td>
													                  		<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#update_expences<?php echo $submitted_idd; ?>'>
					                  											<i class='fa fa-pencil'></i>
					                  										</button>
													                  	</td>
													            	</tr>
...
<?php
	...
	if(isset($_POST['save'])){
            ...
            $jo = mysqli_real_escape_string($con,$_POST['jo']);
