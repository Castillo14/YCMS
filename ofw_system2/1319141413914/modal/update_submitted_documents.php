...
<div class="modal fade" id="update_submitted_documents<?php echo $submitted_id; ?>" hidden="true" role="dialog">
	        <div class="modal-dialog">
	            <div class="modal-content">
	              	...
	              	<div class="modal-body">
	              		...
	              		?>
	    				<form class="form-horizontal" action="update_sub_doc.php" method="post" enctype="multipart/form-data">
