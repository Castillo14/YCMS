	              					...
	              					<table class="table table-hover" id="ample2">
	                					...
	                					<tr>
	                  						...
	                  						<td>
												...
												<a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && employer_waiting_applicant=<?php echo $applicant_id; ?> && getEmployer=<?php echo $getDelete; ?>" class="btn btn-default btn-small">
