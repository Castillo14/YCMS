...
<?php
            ...
            $insert_applicant = "INSERT INTO tbl_applicants (position1,position2,position3,position_selected,first_name,middle_name,last_name,age,gender,contact_number,email_address,address,birth_place,birth_date,civil_status,height,weight,blood_type,religion,language_spoken,father_name,mother_name,passport_number,date_issue,place_issue,employer_id,agent_id,created_by,date_created,application_status,application_mode,removed,date_removed,removed_by,times_abroad,date_hired,date_signed,date_arrival,owwa_sched,biometric_sched,cv_sent,visa_number,remarks) VALUES ('$position1','$position2','$position3','','$first_name','$middle_name','$last_name','$age','$gender','$contact_number','$email_address','$address','$birth_place','$birth_date','$civil_status','$height','$weight','$blood_type','$religion','$language_spoken','$father_name','$mother_name','$passport_number','$date_issue','$place_issue','$employer_','$agent_','$creator',now(),'2','walk-in','No','0000-00-00','','$times_abroad','0000-00-00','0000-00-00','0000-00-00','','','','','')";
