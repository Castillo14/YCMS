			...
			$jScript = md5(rand(1,9));
			 ...
			 $getUpdate = md5(rand(1,9));
				...
				if(isset($_GET['delete_applicant_expense'])){
					...
					$delete_id = $_GET['delete_applicant_expense'];

					$get_exp = "select * from tbl_expenses where expenses_id = '$delete_id'";
	...
	<div class="col-lg-12"><!-- col-lg-12 Starts -->
		<ol class="breadcrumb"><!-- breadcrumb Starts -->
			<li>
				...
				Agnets / Remove Applicant Expense
			</li>
		</ol><!-- breadcrumb Ends -->
	</div><!-- col-lg-12 Ends -->
</div><!-- 1 row Ends -->
		...
		<div class="panel panel-default"><!-- panel panel-default Starts -->
			...
			<div class="panel-body"><!-- panel-body Starts -->
				<form action="" method="post" class="form-horizontal">
	                       		<h3 class="text-center">Are you sure you want to remove <span style="color: red;"><?php echo $e_name; ?></span>&nbsp;?</h3><br>
...
<?php
	...
	if(isset($_POST['delete'])){
		...
		$delete_doc = "delete from tbl_expenses where expenses_id = '$delete_id'";
		...
		if($run_delete){
			...
			echo "
				<script>
					alert('Expense Has Been Removed')
				</script>
			";
