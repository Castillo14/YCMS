...
<div class="modal fade" id="delete_submitted_documents<?php echo $submitted_id; ?>" hidden="true" role="dialog">
	            ...
	            <div class="modal-content">
	              	...
	              	<div class="modal-body">
	              		<?php
	              			...
	              			$get_applicant = "SELECT * FROM tbl_submitted_documents WHERE submitted_id = '$submitted_id'";
	              		...
	              		?>
	    				<form class="form-horizontal" action="delete_sub_doc.php" method="post" enctype="multipart/form-data">
