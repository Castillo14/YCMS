...
<div class="modal fade" id="edit_visa<?php echo $e_id; ?>" hidden="true" role="dialog">
	            ...
	            <div class="modal-content">
	              	<div class="modal-header">
	                	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                  	...
	                  	<center>
	                		<h4 class="modal-title text-center"><b>EDIT VISA NUMBER</b></h4>
	                	</center>
	             	</div>
	              	<div class="modal-body">
	              		<?php
	              			...
	              			$visa = $row_get['visa_number'];

	              		?>
	              		<form class="form-horizontal" action="edit_visaa.php" method="post">
							...
							<div class="form-group"><!-- form-group Starts -->
								...
								<div class="col-md-6">
									<input type="text" name="visa" class="form-control" value="<?php echo $visa; ?>">
								</div>
							</div><!-- form-group Ends -->
							<div class="form-group"><!-- form-group Starts -->
								<label class="col-md-3 control-label">
