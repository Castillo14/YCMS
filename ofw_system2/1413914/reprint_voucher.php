    ...
    <div class="col-lg-12"><!-- col-lg-12 Starts -->
        <div class="panel panel-default"><!-- panel panel-default Starts -->
            ...
            <div class="panel-body"><!-- panel-body Starts -->
                <form class="form-horizontal" action="../TCPDF/User/print_voucher.php" target="_blank" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <div class="col-md-6">
                            <input type="hidden" name="prepare_by" class="form-control" required value="<?php echo $creator; ?>">
                        </div>
                    </div><!-- form-group Ends -->
