...
$row_count = 3;
$i=0;
$query = mysqli_query($con,"SELECT * FROM tbl_applicants WHERE application_status = '2' WHERE removed = 'No'");
...
header('Content-Disposition: attachment;filename="Processing Applicants.xls"');
