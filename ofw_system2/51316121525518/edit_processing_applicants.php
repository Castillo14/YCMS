					                	...
					                	<div id='applicant_info'><!-- applicant_info Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    ...
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <textarea class="form-control" name="birth_place" rows="3" disabled maxlength="224" minlength="5" required><?php echo $e_bplace; ?></textarea>
							                        </div>  
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                ...
							                <div class='col-md-6'><!-- col-md-6 Starts -->
							                    ...
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-8'>
							                            <textarea class="form-control" name="place_issue" rows="4" maxlength="224" disabled minlength="5" required><?php echo $e_pissue; ?></textarea>
							                        </div>
							                    </div>
							                </div><!-- col-md-6 Ends -->
							                <div class='col-md-12'><!-- col-md-12 Starts -->
